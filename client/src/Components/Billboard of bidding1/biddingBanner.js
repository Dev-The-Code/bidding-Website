			...
			<div>
				...
				<div>
					<div className="container baner_text">
						<h4><span className="bannr_txtbid">BIDDING DETAIL</span></h4>
					</div>
				</div>
				<div className="cultus4">
					<div className="container baner_bot_tag">
						<ol className="tag_listt">
							...
							<ul className="cultus6"><a href=""><span className="cultus7">> Bidding Detail</span></a></ul>
						</ol>
					</div>
				</div><br />
			</div>
...
export default bidDetailbanner;